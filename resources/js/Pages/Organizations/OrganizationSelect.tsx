...
export default function InstanceSelect({auth, organizations}: {
    auth: any,
    organizations: any[]
}) {
    ...
    return (
        <DashboardLayout
            ...
            header={<h1>InstanceSelect organization</h1>}
        >
            <Head title="InstanceSelect organization" />

            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">InstanceSelect an organization to edit</div>
